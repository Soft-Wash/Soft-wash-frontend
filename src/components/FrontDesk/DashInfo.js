...
export default function DashInfo() {
  ...
  const [allWashmen, setAllWashmen] = useState([
    {task: 'free', _id: '655e49bad160aea8372bde1d', fullName: 'emmanuel fakaa', email: 'fakaashagbaor@gmail.com', password: '$2a$12$I0yZq2Cvyi/Wqp/DpfGUAuqXKopZycFFmJC9O7m5dtgoJqWM67XzC',  },
    {task: 'free', _id: '655f441ab91ae3b48248ee3b', fullName: 'shegun dambola', email: 'fakaashagbaor2@gmail.com', password: '$2a$12$aSetUkxMFo5jqqD49VYH0u7t0lWDcktEUKsQhKf.MZLlAhnUeU2km',  },
    {task: 'free', _id: '65606acde74306759caae67b', fullName: 'Gerald Fakaa', email: 'theboyfakaa@gmail.com', password: '$2a$12$WAr3XLeanz6oeSBkzD5oMeBSKZZmZOcRHHhZhxxZeth7JR1LI.Gjm',  },
    {_id: '6569edd3abca2b034bf71180', fullName: 'Jerry Peter', email: 'jp@gmail.com', password: '$2a$12$lmlJqINTLg3dnsZ5hGP2XeDNrnHN.Kz0LL6L.n7JHuu.7gM2kQkoS', age: 28,  },
    {_id: '656b07aa97952ceb72ca7a52', fullName: 'Embabs', email: 'emixwrld@gmail.com', password: '$2a$12$sq5VeaQhW94nLHgAmP0OLOc9gbVaee8Xq/03Wf6MW/dAYpvgpac1K', branch: '655debd5ec7b0b6e0f591bf9',  },
    {_id: '659d575fb0c17d76a2d9b669', fullName: 'Joel Obi', email: 'joelobi@gmail.com', password: '$2a$12$2vKDwbCQUjLWIxk1iuLaIOY4E8fRtr3Gwj/H6h/XROpNnq2fd7rl.', branch: '655debc4ec7b0b6e0f591bf7',  }])
    ;
      ...
      >
        ...
        <Col className="border bg-white rounded-4">
          ...
          <Row>
                        {/* {allWashmen.length > 0 ? (
              allWashmen &&
              allWashmen.map((washman, index) => (
                <WashmanProp name={washman.fullName} status={washman.task} />
              ))
            ) : (
              <div className="w-100 h-75 d-flex justify-content-center">
                <div className="d-flex flex-column m-auto">
            ...
            )} */}
            {
              // allWashmen &&
              allWashmen.map((washman, index) => (
                <WashmanProp name={washman.fullName} status={washman.task} key={index}/>
              ))
            }
          </Row>
        </Col>
