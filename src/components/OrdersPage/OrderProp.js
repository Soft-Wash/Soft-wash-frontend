      ...
      {/* <Container className="mt-4 px-4 py-2 shadow border rounded-4"> */}
        <Row className="mt-4 px-5 py-4 shadow-sm rounded-4"> 
          <Col lg={2} md={4} sm={6}>
            ...
            <Row  className="text-secondary fw-normal fs-6">{props.id || "ORDA73FA"}</Row>
          </Col>
          <Col lg={2} md={4} sm={6}>
            <Row className="mb-1 fw-bold fs-6">Pickup Time</Row>
            <Row  className="text-secondary fw-normal fs-6">{props.pickup || "06 Nov, 08:00 - 10:00"}</Row>
          </Col>
          <Col lg={2} md={4} sm={6}>
            <Row className="mb-1 fw-bold fs-6">Address</Row>
            <Row  className="text-secondary fw-normal fs-6">{props.address || "plot Add, Full street, code address."}</Row>
          </Col>
          <Col lg={2} md={4} sm={6}>
            <Row className="mb-1 fw-bold fs-6">Price</Row>
            <Row  className="text-secondary fw-normal fs-6">{props.price || "₦5,000"}</Row>
          </Col>
          <Col lg={2} md={4} sm={6}>
            <Row className="mb-1 fw-bold fs-6">Status</Row>
            <Row  className="text-secondary fw-normal fs-6">{props.status || "Order Placed"}</Row>
          </Col>
