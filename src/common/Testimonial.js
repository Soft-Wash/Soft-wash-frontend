...
export default function Testimonial(props) {
  return (
    <Card
      ...
      style={{ height: "280px", width: "300px", marginLeft:"30px"}}
    >
      <Card.Body className="text-center pb-0">
        <Row className="d-flex gap-1">
          ...
          <Col lg={7} md={7} sm={7}  className="text-secondary  px-0 min-h-sm-40" 
        ...
        <hr/>
        <Row >
          <Col lg={5} md={5} sm="auto" xs="auto" >
            <img src={props.image || Client1} alt="client" className="rounded-circle " style={{height:"65px", width:"65px"}}/>
          </Col>
          <Col lg={7} md={6} sm="auto" xs="auto" >
