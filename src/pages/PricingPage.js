...
function PricingPage() {
  ...
  const pricingContent = () => {
    axiosInstance.get("/services/").then((resp) => {
    ...
    <div>
      {loading ? (
        ...
        <>
          {" "}
          <Navigation />
          <HeaderBanner pageTitle="Pricing" currentPage="Pricing" />
          <div className="pricing-clothtype-header container text-center mt-5 pt-4">
            ...
            <div className="cloth-title-div d-flex justify-content-center text-center mt-4">
              <ul className="cloth-title-div-ul flex-wrap">
                <li
                  className={
                    selectedCategory === "All" ? "all-ptag selected" : ""
                  }
                ...
                <li
                  className={
                    selectedCategory === "Washing" ? "all-ptag selected" : ""
                  }
                ...
                <li
                  className={
                    selectedCategory === "Iron" ? "all-ptag selected" : ""
                  }
                ...
                <li
                  className={
                    selectedCategory === "Dry Clean" ? "all-ptag selected" : ""
                  }
                ...
                <li
                  className={
                    selectedCategory === "Steam Iron" ? "all-ptag selected" : ""
                  }
            ...
            <Row className="justify-content-center gap-0 column-gap-5">
              {filteredData?.map((item, index) => (
                <Col
                  xs={6}
                  md={3}
                  className={`price-container shadow text-center pt-5 pb-5 ${
                    index >= 0 ? "mt-5" : ""
                  }`}
                >
                  ...
                  <Button
                    className="pricing-order-button border-0 mt-2 fw-bold btn-md"
                    size="lg"
